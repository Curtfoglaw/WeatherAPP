...
weather_quotes = [
    ...
    "Rain falls at 35 km/h.",
    "Fog is just a ground cloud.",
    "Warm air rises.",
    "Cold air sinks.",
    "Snow isn’t always white.",
    "Thunder is exploding air.",
    "Humidity boosts heat.",
    "Wind is moving air.",
    "Clouds: sky potatoes.",
    "Rain: free shower DLC.",
    "Wind: nature’s hair stylist.",
    "Sun: world’s biggest lamp.",
    "Storms: dramatic clouds.",
    "Fog: sky confusion.",
    "Weather: sky patch notes.",
    "Umbrellas: portable roofs.",
    "Wind: chaotic neutral.",
    "Rain: sky hydration."
]
